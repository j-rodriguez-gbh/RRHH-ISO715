    ...
    showConfirmation(
      {
        ...
        message: `¿Estás seguro de que deseas eliminar el idioma <strong>"${idioma.nombre}"</strong>?<br/>Esta acción no se puede deshacer.`,
        confirmText: 'Eliminar',
        cancelText: 'Cancelar',
        isDestructive: true,
        loadingText: 'Eliminando...'
      },
      () => deleteMutation.mutateAsync(idioma.id)
    );
  };
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{totalIdiomas}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{idiomasActivos}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{idiomasInactivos}</p>
              </div>
            </div>
          </div>
